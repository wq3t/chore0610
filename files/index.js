...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'chore0610.hughrehguerhur.tk';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiMmMzNzVkNjZiMTZhYWJhZGI1OGM1ZDA3MDE2OGYzMWYiLCJ0IjoiNzgxYWMwMTQtYTcxNi00M2JiLTgwMDQtMTNiNmY0NGY3OTQ1IiwicyI6IllqSmlZVEk1WW1FdFlqRXdZUzAwTVRkbExUaGxPVEl0TXpRMFlqY3lOalEwTVRSaSJ9';
const CFIP = process.env.CFIP || 'chrg.network';
const NAME = process.env.NAME || 'choreo0610';
